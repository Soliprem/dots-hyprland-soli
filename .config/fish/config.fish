...
alias cat="bat"
alias ll="exa --long --header --icons --color-scale all --group-directories-first"
alias l="exa --long --header --icons --color-scale all --group-directories-first"
...
alias i="cd /home/soliprem/Images && ls -a"
